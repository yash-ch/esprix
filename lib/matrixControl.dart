...
class _MatrixControlState extends State<MatrixControl> {
  ...
  void textAddDialogBox(bool edit, [int? index]) {
    ...
    Map<String, String> animations = {
      ...
      "PA_CLOSING": "Closing",
      "PA_GROW_UP": "Grow Up",
      "PA_GROW_DOWN": "Grow Down",
      "PA_GROW_LEFT": "Grow Left",
            ...
            return SingleChildScrollView(
              child: AlertDialog(
                ...
                actions: [
                  ...
                  TextButton(onPressed: () {}, child: const Text("Display")),
                  TextButton(
                      onPressed: () {
                        if (edit) {
                          ...
                          GlobalStateController.state.addToTextList(Map.from(data));
                        }
